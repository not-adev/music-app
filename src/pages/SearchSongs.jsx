...
export default function SerchSong() {
    ...
    return (
        <div className="min-h-screen relative bg-zinc-950 p-6">
            <form onSubmit={(e) => SerachSong(e)} className="sticky z-2 top-0 flex items-center justify-between h-14 rounded-2xl !mb-3.5 !p-6 bg-zinc-800">
                <input
                    required
                    type="text"
                    onChange={(e) => setSongName(e.target.value)}
                    value={songName}
                    className="w-[70%] !font-[Op text-gray-300" placeholder="Search Song" />
                <button type="submit" >
